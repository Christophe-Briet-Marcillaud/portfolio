  ...
  private competences: Competence[] = [
    {
      ...
      element_preuve: 'J’ai débuté mon apprentissage de <strong>Spring</strong> en cours lors de mon semestre cinq avec le développement d’API mais j’ai pu approfondir mes compétences lors de mon arrivé chez 2MoRO.\n' +
        ...
        'Le projet de cette application se nomme <a href="/portfolio/realisations/geosavior">GeoSavior</a>, elle a pour but de permettre aux personnes rencontrant un animal marin en détresse de contacter les secours adaptés à l’animal en question rapidement et efficacement. \n' +
        ...
        'Je continue actuellement à utiliser <strong>Spring</strong> et ses différentes librairies dans le développement du logiciel <a href="/portfolio/realisations/aerowebb">Aero-Webb</a>. \n' +
      ...
      autocritique: 'En tant que membre de <strong>l’équipe architecture</strong>, connaître l’utilisation du <strong>Framework</strong> qui définit la base de l’architecture de l’application est un point très important. \n' +
        ...
        'J’ai également travaillé sur <strong>Spring</strong> dans des contextes plus compliqués comme la configuration de nouveaux modules d’un projet ou l’implémentation de job avec <strong>Spring Batch</strong> qui m’ont apportés une polyvalence au niveau de son utilisation.\n' +
    ...
    },
    {
      ...
      definition: '<strong>Hibernate</strong> est un <strong>Framework</strong> (ensemble de fonctionnalités qui servent à simplifier la construction et définir une architecture de l’application) développé et utilisé avec le langage de programmation <strong>Java</strong>.\n' +
        ...
        'Il est utilisé sur une multitude de projets incluant également le logiciel <a href="/portfolio/realisations/aerowebb">Aero-Webb</a> sur lequel j’ai travaillé durant mon stage et mon alternance.\n',
      element_preuve: 'Mon apprentissage d’<strong>Hibernate</strong> a débuté à l’école lors du semestre quatre avec l’apprentissage de <strong>Java</strong> mais j’ai pu approfondir mes compétences lors de mon arrivé chez 2MoRO.\n' +
        ...
        'Ce projet se nomme <a href="/portfolio/realisations/link_n_trade"><a href="/portfolio/realisations/link_n_trade">Link & Trade</a></a> et avait pour but d’appuyer le projet de lycéens du Lycée de Borda situé à Saint Paul les Dax . \n' +
        ...
        'Par la suite, j’ai travaillé avec <strong>Hibernate</strong> dans le cadre de la réalisation d’une API pour l’application Android <a href="/portfolio/realisations/geosavior">GeoSavior</a> que j’ai réalisé lors de mon cinquième semestre. \n' +
        ...
        'Finalement, je continue actuellement à utiliser <strong>Hibernate</strong> dans <a href="/portfolio/realisations/aerowebb">Aero-Webb</a>. \n' +
      ...
      autocritique: 'En tant que membre de <strong>l’équipe architecture</strong>, connaître l’utilisation des bases de l’architecture de l’application est important. \n' +
        ...
        'J’ai acquis une bonne maîtrise dans l’utilisation et la configuration d’<strong>Hibernate</strong> principalement grâce aux travaux réalisés sur <a href="/portfolio/realisations/aerowebb">Aero-Webb</a> qui m’ont permis d’aller en profondeur dans son utilisation et sa configuration. \n' +
    ...
    },
    {
      ...
      element_preuve: 'J’ai commencé mon apprentissage d’<strong>Angular</strong> lors de mon quatrième semestre. \n' +
        ...
        'J’ai mis en pratique <strong>Angular</strong> pour la première fois lors du développement du projet <a href="/portfolio/realisations/link_n_trade"><a href="/portfolio/realisations/link_n_trade">Link & Trade</a></a> durant mon quatrième semestre. \n' +
        ...
        'Ensuite, lors de mon cinquième semestre, j’ai continué à travailler avec <strong>Angular</strong> sur le projet <a href="/portfolio/realisations/geosavior">GeoSavior</a>. Il avait pour but de réaliser une application mobile de sauvetage d’animaux marins. \n' +
        ...
        'Lors de mon stage et mon alternance chez 2MoRO, j’ai travaillé sur le logiciel <a href="/portfolio/realisations/aerowebb">Aero-Webb</a>. \n' +
      ...
      autocritique: 'En tant que membre de <strong>l’équipe architecture</strong>, connaître le fonctionnement du <strong>Framework</strong> utilisé pour le Frontend de l’application est nécessaire à la compréhension des différentes missions que je peux être amené à réaliser. \n' +
        ...
        '<a href="/portfolio/realisations/link_n_trade"><a href="/portfolio/realisations/link_n_trade">Link & Trade</a></a> ainsi que <a href="/portfolio/realisations/geosavior">GeoSavior</a> m’ont permis de voir comment développer une application en partant de zéro et <a href="/portfolio/realisations/aerowebb">Aero-Webb</a> m’a permis de découvrir de nouveaux composants en les implémentant et approfondir les parties que j’avais déjà apprises.\n' +
        'J’ai pu utiliser <strong>Angular</strong> dans des projets de petite ou moyenne taille réalisés à l’école et sur une application plus complexe comme <a href="/portfolio/realisations/aerowebb">Aero-Webb</a>. \n' +
    ...
    },
    {
      ...
      element_preuve: 'Mon apprentissage de <strong>SQL</strong> a débuté lors de mon deuxième semestre à l’école avec le développement d’un site web dynamique en <strong>PHP</strong> que j’ai pu approfondir lors de tous les semestres suivants ainsi qu’en entreprise lors de mon arrivé chez 2MoRO.\n' +
        ...
        'Lors du quatrième semestre, j’ai travaillé sur l’application web <a href="/portfolio/realisations/link_n_trade">Link & Trade</a> qui permettait de réaliser des ventes du style Vinted au sein d’un lycée. \n' +
      ...
      evolution: 'La prochaine étape dans mon utilisation de <strong>SQL</strong> est de continuer à travailler sur les différentes mises à jour de la <strong>base de données</strong> d’<a href="/portfolio/realisations/aerowebb">Aero-Webb</a> en <strong>PostgreSQL</strong>. \n' +
    ...
    },
    {
      ...
      element_preuve: 'Mon apprentissage du <strong>marketing</strong> professionnel a débuté à l’école lors du semestre deux avec l’aide apporté à une vendeuse par correspondance de l’entreprise <strong>« Secrets de Miel »</strong> pour sa communication sur les <strong>réseaux sociaux</strong>.\n' +
        ...
        'Par la suite, j’ai travaillé sur le projet <a href="/portfolio/realisations/speedclean">SpeedClean</a> dont le but était de réaliser un aller-retour de soixante kilomètres en vélo afin de nettoyer une plage. \n' +
    ...
    },
    {
      ...
      element_preuve:'Pendant mon deuxième semestre, j’ai fait l’expérience de la <strong>rédaction de documentation</strong>. J’ai pu rédiger une documentation technique pour documenter le code PHP de l’application sur laquelle j’ai travaillé durant ce semestre. Cela a permis aux personnes qui reprennent le projet d’avoir une base et une explication de ce qui a été fait. \n' +
        ...
        'J’ai travaillé sur l’utilisation des annotations et <strong>Criteria</strong> <strong>JPA</strong>, l’utilisation de la librairie <strong>Spring Batch</strong> et des profils <strong>Spring</strong> permettant d’améliorer les performances de l’application <a href="/portfolio/realisations/aerowebb">Aero-Webb</a>. \n' +
    ...
    },
    {
      ...
      element_preuve: 'J’ai débuté mon apprentissage de la <strong>méthode agile</strong> et plus particulièrement de la méthodologie scrum en cours lors de mon semestre trois avec la mise en place de cette dernière pour la réalisation de notre projet. \n' +
        ...
        'Chez 2MoRO, j’ai retrouvé une partie de la philosophie de la <strong>méthode agile</strong> avec une livraison intermédiaire après une certaine période de temps ce qui est compatible avec une application en constante évolution comme <a href="/portfolio/realisations/aerowebb">Aero-Webb</a>.\n',
      autocritique: 'En tant que membre de <strong>l’équipe architecture</strong>, connaître les différentes manières de piloter un projet n’est pas essentiel. \n' +
        ...
        'J’ai aussi pu voir et approfondir ma maîtrise de la <strong>méthode agile</strong> liée à une autre méthode de pilotage de projet en travaillant sur <a href="/portfolio/realisations/aerowebb">Aero-Webb</a>.\n' +
    ...
    },
    {
      ...
      element_preuve: 'Mon apprentissage de la <strong>gestion de budget</strong> a débuté lors de ma formation précédent l’ESIEA au lycée hôtelier de Biarritz en tant que cuisinier. \n' +
        ...
        'J’ai travaillé sur la <strong>gestion de budget</strong> concernant le projet <a href="/portfolio/realisations/speedclean">SpeedClean</a> qui avait pour but de réaliser un trajet de trente kilomètres en vélo depuis Taller jusqu’à Vielles-Saint-Giron afin de nettoyer sa plage.\n' +
      ...
      autocritique: 'En tant que <strong>développeur</strong>, la <strong>gestion de budget</strong> n’est pas essentielle mais avoir des connaissances sur ce sujet est une plus-value de par son utilisation dans la vie en général et une potentielle participation dans la vie en entreprise.\n' +
        'Grâce aux différents exercices lors de ma formation de cuisinier et aux différentes situations auxquelles j’ai été confronté entre <a href="/portfolio/realisations/speedclean">SpeedClean</a> et la <a href="/portfolio/realisations/gestion_presidence_bde">gestion de la présidence du bureau des étudiants</a>, j’ai acquis une bonne maîtrise de la <strong>gestion de budget</strong>.\n' +
